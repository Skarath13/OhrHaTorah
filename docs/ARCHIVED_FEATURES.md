...
- **Reason:** The panel labeled Hebcal astronomical zmanim as `Shacharit`, `Mincha`, and `Ma'ariv`. Visitors could reasonably confuse those computed markers with Ohr HaTorah's actual service schedule.
