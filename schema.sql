...
-- Congregation-owned calendar event definitions. Hebcal holidays and
-- candle-lighting times are fetched read-only and never stored in this table.
...
-- Tracks one-time baseline data separately from table creation. This prevents a
-- later schema re-run from restoring an event that an editor intentionally deleted.
